...
from ....types.api.datasets import resource_group_add_params
from ....types.api.datasets.resource_group_add_response import ResourceGroupAddResponse
from ....types.api.datasets.resource_group_get_response import ResourceGroupGetResponse
...
class ResourceGroupResource(SyncAPIResource):
    ...
    def add(
        ...
        *,
        ...
        return self._post(
            f"/api/datasets/{namespace}/{repo}/resource-group",
