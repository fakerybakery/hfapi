...
from ....types.api.spaces import variable_delete_params, variable_upsert_params
...
class VariablesResource(SyncAPIResource):
    ...
    def delete(
        ...
        *,
        ...
        return self._delete(
            f"/api/spaces/{namespace}/{repo}/variables",
            body=maybe_transform({"key": key}, variable_delete_params.VariableDeleteParams),
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                variable_upsert_params.VariableUpsertParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    async def delete(
        ...
        *,
        ...
        return await self._delete(
            f"/api/spaces/{namespace}/{repo}/variables",
            body=await async_maybe_transform({"key": key}, variable_delete_params.VariableDeleteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
