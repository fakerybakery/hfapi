...
from .....types.api.organizations.billing import usage_get_params
from .....types.api.organizations.billing.usage_get_response import UsageGetResponse
...
class UsageResource(SyncAPIResource):
    ...
    def get(
        ...
        *,
        ...
        return self._get(
            f"/api/organizations/{name}/billing/usage",
    ...
    def get_live(
        ...
        *,
        ...
        return self._get(
            f"/api/organizations/{name}/billing/usage/live",
            options=make_request_options(
