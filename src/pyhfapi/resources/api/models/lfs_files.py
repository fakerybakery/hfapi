...
from ....types.api.models import lfs_file_list_params, lfs_file_delete_params, lfs_file_delete_batch_params
from ....types.api.models.lfs_file_list_response import LFSFileListResponse
...
class LFSFilesResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            f"/api/models/{namespace}/{repo}/lfs-files",
    ...
    def delete(
        ...
        *,
        ...
        return self._delete(
            f"/api/models/{namespace}/{repo}/lfs-files/{sha}",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
    ...
    def delete_batch(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._post(
            f"/api/models/{namespace}/{repo}/lfs-files/batch",
