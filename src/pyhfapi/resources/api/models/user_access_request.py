...
from ....types.api.models import user_access_request_grant_params, user_access_request_handle_params
from ....types.api.models.user_access_request_list_response import UserAccessRequestListResponse
...
class UserAccessRequestResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            f"/api/models/{namespace}/{repo}/user-access-request/{status}",
    ...
    def cancel(
        ...
        *,
        ...
        return self._post(
            f"/api/models/{namespace}/{repo}/user-access-request/cancel",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    def grant(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._post(
            f"/api/models/{namespace}/{repo}/user-access-request/grant",
    ...
    def handle(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._post(
            f"/api/models/{namespace}/{repo}/user-access-request/handle",
            body=maybe_transform(
                {
                    "status": status,
