...
from ....types.api.models import resource_group_add_params
from ....types.api.models.resource_group_add_response import ResourceGroupAddResponse
from ....types.api.models.resource_group_get_response import ResourceGroupGetResponse
...
class ResourceGroupResource(SyncAPIResource):
    ...
    def add(
        ...
        *,
        ...
        return self._post(
            f"/api/models/{namespace}/{repo}/resource-group",
