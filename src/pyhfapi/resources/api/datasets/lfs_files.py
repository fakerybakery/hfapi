...
from ....types.api.datasets import lfs_file_list_params, lfs_file_delete_params, lfs_file_delete_batch_params
from ....types.api.datasets.lfs_file_list_response import LFSFileListResponse
...
class LFSFilesResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            f"/api/datasets/{namespace}/{repo}/lfs-files",
    ...
    def delete(
        ...
        *,
        namespace: str,
        repo: str,
        rewrite_history: object | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._delete(
            f"/api/datasets/{namespace}/{repo}/lfs-files/{sha}",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
    ...
    def delete_batch(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._post(
            f"/api/datasets/{namespace}/{repo}/lfs-files/batch",
