...
class UsageResource(SyncAPIResource):
    ...
    def get_live_usage(
        ...
        *,
        ...
        return self._get(
            f"/api/users/{username}/billing/usage/live",
...
class UsageResourceWithRawResponse:
    def __init__(self, usage: UsageResource) -> None:
        ...
        self.get_live_usage = to_raw_response_wrapper(
...
class AsyncUsageResourceWithRawResponse:
    def __init__(self, usage: AsyncUsageResource) -> None:
        ...
        self.get_live_usage = async_to_raw_response_wrapper(
            usage.get_live_usage,
        )
...
class UsageResourceWithStreamingResponse:
    def __init__(self, usage: UsageResource) -> None:
        ...
        self.get_live_usage = to_streamed_response_wrapper(
            usage.get_live_usage,
        )
...
class AsyncUsageResourceWithStreamingResponse:
    def __init__(self, usage: AsyncUsageResource) -> None:
        ...
        self.get_live_usage = async_to_streamed_response_wrapper(
            usage.get_live_usage,
        )
