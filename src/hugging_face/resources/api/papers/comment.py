...
from ....types.api.papers import comment_reply_params, comment_create_params
from ....types.api.papers.comment_reply_response import CommentReplyResponse
from ....types.api.papers.comment_create_response import CommentCreateResponse
...
class CommentResource(SyncAPIResource):
    ...
    def reply(
        ...
        *,
        ...
        return self._post(
            f"/api/papers/{paper_id}/comment/{comment_id}/reply",
