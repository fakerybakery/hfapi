...
class TestSpaces:
    ...
    def test_method_resolve_file(self, client: HuggingFace) -> None:
        space = client.spaces.resolve_file(
            path="path",
            namespace="namespace",
            repo="repo",
            rev="rev",
        )
        assert_matches_type(SpaceResolveFileResponse, space, path=["response"])
    ...
    def test_raw_response_resolve_file(self, client: HuggingFace) -> None:
        response = client.spaces.with_raw_response.resolve_file(
            path="path",
            namespace="namespace",
            repo="repo",
            rev="rev",
    ...
    def test_streaming_response_resolve_file(self, client: HuggingFace) -> None:
        with client.spaces.with_streaming_response.resolve_file(
            path="path",
            namespace="namespace",
            repo="repo",
            rev="rev",
    ...
    def test_path_params_resolve_file(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.spaces.with_raw_response.resolve_file(
                path="path",
                namespace="",
                repo="repo",
                rev="rev",
...
class TestAsyncSpaces:
    ...
    async def test_method_resolve_file(self, async_client: AsyncHuggingFace) -> None:
        space = await async_client.spaces.resolve_file(
            path="path",
            namespace="namespace",
            repo="repo",
            rev="rev",
    ...
    async def test_raw_response_resolve_file(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.spaces.with_raw_response.resolve_file(
            path="path",
            namespace="namespace",
            repo="repo",
            rev="rev",
    ...
    async def test_streaming_response_resolve_file(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.spaces.with_streaming_response.resolve_file(
            path="path",
            namespace="namespace",
            repo="repo",
            rev="rev",
    ...
    async def test_path_params_resolve_file(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.spaces.with_raw_response.resolve_file(
                path="path",
                namespace="",
                repo="repo",
                rev="rev",
