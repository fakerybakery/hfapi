...
class TestDatasets:
    ...
    def test_method_check_preupload(self, client: HuggingFace) -> None:
        dataset = client.api.datasets.check_preupload(
            rev="rev",
            namespace="namespace",
            repo="repo",
            files=[
        ...
        assert_matches_type(DatasetCheckPreuploadResponse, dataset, path=["response"])
    ...
    def test_raw_response_check_preupload(self, client: HuggingFace) -> None:
        response = client.api.datasets.with_raw_response.check_preupload(
            rev="rev",
            namespace="namespace",
            repo="repo",
            files=[
    ...
    def test_streaming_response_check_preupload(self, client: HuggingFace) -> None:
        with client.api.datasets.with_streaming_response.check_preupload(
            rev="rev",
            namespace="namespace",
            repo="repo",
            files=[
    ...
    def test_path_params_check_preupload(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.datasets.with_raw_response.check_preupload(
                rev="rev",
                namespace="",
                repo="repo",
                files=[
    ...
    def test_method_commit(self, client: HuggingFace) -> None:
        dataset = client.api.datasets.commit(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
        assert_matches_type(DatasetCommitResponse, dataset, path=["response"])
    ...
    def test_raw_response_commit(self, client: HuggingFace) -> None:
        response = client.api.datasets.with_raw_response.commit(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
    ...
    def test_streaming_response_commit(self, client: HuggingFace) -> None:
        with client.api.datasets.with_streaming_response.commit(
            rev="rev",
            namespace="namespace",
            repo="repo",
        ) as response:
    ...
    def test_path_params_commit(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.datasets.with_raw_response.commit(
                rev="rev",
                namespace="",
                repo="repo",
            )
    ...
    def test_method_compare(self, client: HuggingFace) -> None:
        dataset = client.api.datasets.compare(
            compare="compare",
            namespace="namespace",
            repo="repo",
        )
    ...
    def test_raw_response_compare(self, client: HuggingFace) -> None:
        response = client.api.datasets.with_raw_response.compare(
            compare="compare",
            namespace="namespace",
            repo="repo",
        )
    ...
    def test_streaming_response_compare(self, client: HuggingFace) -> None:
        with client.api.datasets.with_streaming_response.compare(
            compare="compare",
            namespace="namespace",
            repo="repo",
        ) as response:
    ...
    def test_path_params_compare(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.datasets.with_raw_response.compare(
                compare="compare",
                namespace="",
                repo="repo",
            )
    ...
    def test_method_get_notebook_url(self, client: HuggingFace) -> None:
        dataset = client.api.datasets.get_notebook_url(
            path="path",
            namespace="namespace",
            repo="repo",
            rev="rev",
        )
        assert_matches_type(DatasetGetNotebookURLResponse, dataset, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_get_notebook_url(self, client: HuggingFace) -> None:
        response = client.api.datasets.with_raw_response.get_notebook_url(
            path="path",
            namespace="namespace",
            repo="repo",
            rev="rev",
    ...
    def test_streaming_response_get_notebook_url(self, client: HuggingFace) -> None:
        with client.api.datasets.with_streaming_response.get_notebook_url(
            path="path",
            namespace="namespace",
            repo="repo",
            rev="rev",
    ...
    def test_path_params_get_notebook_url(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.datasets.with_raw_response.get_notebook_url(
                path="path",
                namespace="",
                repo="repo",
                rev="rev",
    ...
    def test_method_get_security_status(self, client: HuggingFace) -> None:
        dataset = client.api.datasets.get_security_status(
            repo="repo",
            namespace="namespace",
        )
        assert_matches_type(DatasetGetSecurityStatusResponse, dataset, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_get_security_status(self, client: HuggingFace) -> None:
        response = client.api.datasets.with_raw_response.get_security_status(
            repo="repo",
            namespace="namespace",
        )
    ...
    def test_streaming_response_get_security_status(self, client: HuggingFace) -> None:
        with client.api.datasets.with_streaming_response.get_security_status(
            repo="repo",
            namespace="namespace",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_get_security_status(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.datasets.with_raw_response.get_security_status(
                repo="repo",
                namespace="",
            )
    ...
    def test_method_get_xet_read_token(self, client: HuggingFace) -> None:
        dataset = client.api.datasets.get_xet_read_token(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
        assert_matches_type(DatasetGetXetReadTokenResponse, dataset, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_get_xet_read_token(self, client: HuggingFace) -> None:
        response = client.api.datasets.with_raw_response.get_xet_read_token(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
    ...
    def test_streaming_response_get_xet_read_token(self, client: HuggingFace) -> None:
        with client.api.datasets.with_streaming_response.get_xet_read_token(
            rev="rev",
            namespace="namespace",
            repo="repo",
        ) as response:
    ...
    def test_path_params_get_xet_read_token(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.datasets.with_raw_response.get_xet_read_token(
                rev="rev",
                namespace="",
                repo="repo",
            )
    ...
    def test_method_get_xet_write_token(self, client: HuggingFace) -> None:
        dataset = client.api.datasets.get_xet_write_token(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
        assert_matches_type(DatasetGetXetWriteTokenResponse, dataset, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_get_xet_write_token(self, client: HuggingFace) -> None:
        response = client.api.datasets.with_raw_response.get_xet_write_token(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
    ...
    def test_streaming_response_get_xet_write_token(self, client: HuggingFace) -> None:
        with client.api.datasets.with_streaming_response.get_xet_write_token(
            rev="rev",
            namespace="namespace",
            repo="repo",
        ) as response:
    ...
    def test_path_params_get_xet_write_token(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.datasets.with_raw_response.get_xet_write_token(
                rev="rev",
                namespace="",
                repo="repo",
            )
    ...
    def test_method_list_commits(self, client: HuggingFace) -> None:
        dataset = client.api.datasets.list_commits(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
        assert_matches_type(DatasetListCommitsResponse, dataset, path=["response"])
    ...
    def test_raw_response_list_commits(self, client: HuggingFace) -> None:
        response = client.api.datasets.with_raw_response.list_commits(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
    ...
    def test_streaming_response_list_commits(self, client: HuggingFace) -> None:
        with client.api.datasets.with_streaming_response.list_commits(
            rev="rev",
            namespace="namespace",
            repo="repo",
        ) as response:
    ...
    def test_path_params_list_commits(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.datasets.with_raw_response.list_commits(
                rev="rev",
                namespace="",
                repo="repo",
            )
    ...
    def test_method_list_paths_info(self, client: HuggingFace) -> None:
        dataset = client.api.datasets.list_paths_info(
            rev="rev",
            namespace="namespace",
            repo="repo",
            expand=True,
        ...
        assert_matches_type(DatasetListPathsInfoResponse, dataset, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_list_paths_info(self, client: HuggingFace) -> None:
        response = client.api.datasets.with_raw_response.list_paths_info(
            rev="rev",
            namespace="namespace",
            repo="repo",
            expand=True,
    ...
    def test_streaming_response_list_paths_info(self, client: HuggingFace) -> None:
        with client.api.datasets.with_streaming_response.list_paths_info(
            rev="rev",
            namespace="namespace",
            repo="repo",
            expand=True,
    ...
    def test_path_params_list_paths_info(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.datasets.with_raw_response.list_paths_info(
                rev="rev",
                namespace="",
                repo="repo",
                expand=True,
    ...
    def test_method_list_refs(self, client: HuggingFace) -> None:
        dataset = client.api.datasets.list_refs(
            repo="repo",
            namespace="namespace",
        )
        assert_matches_type(DatasetListRefsResponse, dataset, path=["response"])
    ...
    def test_raw_response_list_refs(self, client: HuggingFace) -> None:
        response = client.api.datasets.with_raw_response.list_refs(
            repo="repo",
            namespace="namespace",
        )
    ...
    def test_streaming_response_list_refs(self, client: HuggingFace) -> None:
        with client.api.datasets.with_streaming_response.list_refs(
            repo="repo",
            namespace="namespace",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_list_refs(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.datasets.with_raw_response.list_refs(
                repo="repo",
                namespace="",
            )
    ...
    def test_method_list_tree_content(self, client: HuggingFace) -> None:
        dataset = client.api.datasets.list_tree_content(
            path="path",
            namespace="namespace",
            repo="repo",
            rev="rev",
        )
        assert_matches_type(DatasetListTreeContentResponse, dataset, path=["response"])
    ...
    def test_raw_response_list_tree_content(self, client: HuggingFace) -> None:
        response = client.api.datasets.with_raw_response.list_tree_content(
            path="path",
            namespace="namespace",
            repo="repo",
            rev="rev",
    ...
    def test_streaming_response_list_tree_content(self, client: HuggingFace) -> None:
        with client.api.datasets.with_streaming_response.list_tree_content(
            path="path",
            namespace="namespace",
            repo="repo",
            rev="rev",
    ...
    def test_path_params_list_tree_content(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.datasets.with_raw_response.list_tree_content(
                path="path",
                namespace="",
                repo="repo",
                rev="rev",
    ...
    def test_method_super_squash(self, client: HuggingFace) -> None:
        dataset = client.api.datasets.super_squash(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
        assert_matches_type(DatasetSuperSquashResponse, dataset, path=["response"])
    ...
    def test_raw_response_super_squash(self, client: HuggingFace) -> None:
        response = client.api.datasets.with_raw_response.super_squash(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
    ...
    def test_streaming_response_super_squash(self, client: HuggingFace) -> None:
        with client.api.datasets.with_streaming_response.super_squash(
            rev="rev",
            namespace="namespace",
            repo="repo",
        ) as response:
    ...
    def test_path_params_super_squash(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.datasets.with_raw_response.super_squash(
                rev="rev",
                namespace="",
                repo="repo",
            )
    ...
    def test_method_update_settings(self, client: HuggingFace) -> None:
        dataset = client.api.datasets.update_settings(
            repo="repo",
            namespace="namespace",
        )
        assert_matches_type(DatasetUpdateSettingsResponse, dataset, path=["response"])
    ...
    def test_raw_response_update_settings(self, client: HuggingFace) -> None:
        response = client.api.datasets.with_raw_response.update_settings(
            repo="repo",
            namespace="namespace",
        )
    ...
    def test_streaming_response_update_settings(self, client: HuggingFace) -> None:
        with client.api.datasets.with_streaming_response.update_settings(
            repo="repo",
            namespace="namespace",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_update_settings(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.datasets.with_raw_response.update_settings(
                repo="repo",
                namespace="",
            )
...
class TestAsyncDatasets:
    ...
    async def test_method_check_preupload(self, async_client: AsyncHuggingFace) -> None:
        dataset = await async_client.api.datasets.check_preupload(
            rev="rev",
            namespace="namespace",
            repo="repo",
            files=[
    ...
    async def test_raw_response_check_preupload(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.datasets.with_raw_response.check_preupload(
            rev="rev",
            namespace="namespace",
            repo="repo",
            files=[
    ...
    async def test_streaming_response_check_preupload(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.datasets.with_streaming_response.check_preupload(
            rev="rev",
            namespace="namespace",
            repo="repo",
            files=[
    ...
    async def test_path_params_check_preupload(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.datasets.with_raw_response.check_preupload(
                rev="rev",
                namespace="",
                repo="repo",
                files=[
    ...
    async def test_method_commit(self, async_client: AsyncHuggingFace) -> None:
        dataset = await async_client.api.datasets.commit(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
    ...
    async def test_raw_response_commit(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.datasets.with_raw_response.commit(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
    ...
    async def test_streaming_response_commit(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.datasets.with_streaming_response.commit(
            rev="rev",
            namespace="namespace",
            repo="repo",
        ) as response:
    ...
    async def test_path_params_commit(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.datasets.with_raw_response.commit(
                rev="rev",
                namespace="",
                repo="repo",
            )
    ...
    async def test_method_compare(self, async_client: AsyncHuggingFace) -> None:
        dataset = await async_client.api.datasets.compare(
            compare="compare",
            namespace="namespace",
            repo="repo",
        )
    ...
    async def test_raw_response_compare(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.datasets.with_raw_response.compare(
            compare="compare",
            namespace="namespace",
            repo="repo",
        )
    ...
    async def test_streaming_response_compare(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.datasets.with_streaming_response.compare(
            compare="compare",
            namespace="namespace",
            repo="repo",
        ) as response:
    ...
    async def test_path_params_compare(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.datasets.with_raw_response.compare(
                compare="compare",
                namespace="",
                repo="repo",
            )
    ...
    async def test_method_get_notebook_url(self, async_client: AsyncHuggingFace) -> None:
        dataset = await async_client.api.datasets.get_notebook_url(
            path="path",
            namespace="namespace",
            repo="repo",
            rev="rev",
    ...
    async def test_raw_response_get_notebook_url(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.datasets.with_raw_response.get_notebook_url(
            path="path",
            namespace="namespace",
            repo="repo",
            rev="rev",
    ...
    async def test_streaming_response_get_notebook_url(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.datasets.with_streaming_response.get_notebook_url(
            path="path",
            namespace="namespace",
            repo="repo",
            rev="rev",
    ...
    async def test_path_params_get_notebook_url(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.datasets.with_raw_response.get_notebook_url(
                path="path",
                namespace="",
                repo="repo",
                rev="rev",
    ...
    async def test_method_get_security_status(self, async_client: AsyncHuggingFace) -> None:
        dataset = await async_client.api.datasets.get_security_status(
            repo="repo",
            namespace="namespace",
        )
        assert_matches_type(DatasetGetSecurityStatusResponse, dataset, path=["response"])
    ...
    async def test_raw_response_get_security_status(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.datasets.with_raw_response.get_security_status(
            repo="repo",
            namespace="namespace",
        )
    ...
    async def test_streaming_response_get_security_status(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.datasets.with_streaming_response.get_security_status(
            repo="repo",
            namespace="namespace",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get_security_status(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.datasets.with_raw_response.get_security_status(
                repo="repo",
                namespace="",
            )
    ...
    async def test_method_get_xet_read_token(self, async_client: AsyncHuggingFace) -> None:
        dataset = await async_client.api.datasets.get_xet_read_token(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
    ...
    async def test_raw_response_get_xet_read_token(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.datasets.with_raw_response.get_xet_read_token(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
    ...
    async def test_streaming_response_get_xet_read_token(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.datasets.with_streaming_response.get_xet_read_token(
            rev="rev",
            namespace="namespace",
            repo="repo",
        ) as response:
    ...
    async def test_path_params_get_xet_read_token(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.datasets.with_raw_response.get_xet_read_token(
                rev="rev",
                namespace="",
                repo="repo",
            )
    ...
    async def test_method_get_xet_write_token(self, async_client: AsyncHuggingFace) -> None:
        dataset = await async_client.api.datasets.get_xet_write_token(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
    ...
    async def test_raw_response_get_xet_write_token(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.datasets.with_raw_response.get_xet_write_token(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
    ...
    async def test_streaming_response_get_xet_write_token(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.datasets.with_streaming_response.get_xet_write_token(
            rev="rev",
            namespace="namespace",
            repo="repo",
        ) as response:
    ...
    async def test_path_params_get_xet_write_token(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.datasets.with_raw_response.get_xet_write_token(
                rev="rev",
                namespace="",
                repo="repo",
            )
    ...
    async def test_method_list_commits(self, async_client: AsyncHuggingFace) -> None:
        dataset = await async_client.api.datasets.list_commits(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
    ...
    async def test_raw_response_list_commits(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.datasets.with_raw_response.list_commits(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
    ...
    async def test_streaming_response_list_commits(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.datasets.with_streaming_response.list_commits(
            rev="rev",
            namespace="namespace",
            repo="repo",
        ) as response:
    ...
    async def test_path_params_list_commits(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.datasets.with_raw_response.list_commits(
                rev="rev",
                namespace="",
                repo="repo",
            )
    ...
    async def test_method_list_paths_info(self, async_client: AsyncHuggingFace) -> None:
        dataset = await async_client.api.datasets.list_paths_info(
            rev="rev",
            namespace="namespace",
            repo="repo",
            expand=True,
    ...
    async def test_raw_response_list_paths_info(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.datasets.with_raw_response.list_paths_info(
            rev="rev",
            namespace="namespace",
            repo="repo",
            expand=True,
    ...
    async def test_streaming_response_list_paths_info(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.datasets.with_streaming_response.list_paths_info(
            rev="rev",
            namespace="namespace",
            repo="repo",
            expand=True,
    ...
    async def test_path_params_list_paths_info(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.datasets.with_raw_response.list_paths_info(
                rev="rev",
                namespace="",
                repo="repo",
                expand=True,
    ...
    async def test_method_list_refs(self, async_client: AsyncHuggingFace) -> None:
        dataset = await async_client.api.datasets.list_refs(
            repo="repo",
            namespace="namespace",
        )
        assert_matches_type(DatasetListRefsResponse, dataset, path=["response"])
    ...
    async def test_raw_response_list_refs(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.datasets.with_raw_response.list_refs(
            repo="repo",
            namespace="namespace",
        )
    ...
    async def test_streaming_response_list_refs(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.datasets.with_streaming_response.list_refs(
            repo="repo",
            namespace="namespace",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_list_refs(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.datasets.with_raw_response.list_refs(
                repo="repo",
                namespace="",
            )
    ...
    async def test_method_list_tree_content(self, async_client: AsyncHuggingFace) -> None:
        dataset = await async_client.api.datasets.list_tree_content(
            path="path",
            namespace="namespace",
            repo="repo",
            rev="rev",
    ...
    async def test_raw_response_list_tree_content(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.datasets.with_raw_response.list_tree_content(
            path="path",
            namespace="namespace",
            repo="repo",
            rev="rev",
    ...
    async def test_streaming_response_list_tree_content(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.datasets.with_streaming_response.list_tree_content(
            path="path",
            namespace="namespace",
            repo="repo",
            rev="rev",
    ...
    async def test_path_params_list_tree_content(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.datasets.with_raw_response.list_tree_content(
                path="path",
                namespace="",
                repo="repo",
                rev="rev",
    ...
    async def test_method_super_squash(self, async_client: AsyncHuggingFace) -> None:
        dataset = await async_client.api.datasets.super_squash(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
    ...
    async def test_raw_response_super_squash(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.datasets.with_raw_response.super_squash(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
    ...
    async def test_streaming_response_super_squash(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.datasets.with_streaming_response.super_squash(
            rev="rev",
            namespace="namespace",
            repo="repo",
        ) as response:
    ...
    async def test_path_params_super_squash(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.datasets.with_raw_response.super_squash(
                rev="rev",
                namespace="",
                repo="repo",
            )
    ...
    async def test_method_update_settings(self, async_client: AsyncHuggingFace) -> None:
        dataset = await async_client.api.datasets.update_settings(
            repo="repo",
            namespace="namespace",
        )
        assert_matches_type(DatasetUpdateSettingsResponse, dataset, path=["response"])
    ...
    async def test_raw_response_update_settings(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.datasets.with_raw_response.update_settings(
            repo="repo",
            namespace="namespace",
        )
    ...
    async def test_streaming_response_update_settings(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.datasets.with_streaming_response.update_settings(
            repo="repo",
            namespace="namespace",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_update_settings(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.datasets.with_raw_response.update_settings(
                repo="repo",
                namespace="",
            )
