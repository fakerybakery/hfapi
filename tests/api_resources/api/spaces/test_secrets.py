...
class TestSecrets:
    ...
    def test_method_delete(self, client: HuggingFace) -> None:
        secret = client.api.spaces.secrets.delete(
            repo="repo",
            namespace="namespace",
            key="key",
        )
    ...
    def test_raw_response_delete(self, client: HuggingFace) -> None:
        response = client.api.spaces.secrets.with_raw_response.delete(
            repo="repo",
            namespace="namespace",
            key="key",
        )
    ...
    def test_streaming_response_delete(self, client: HuggingFace) -> None:
        with client.api.spaces.secrets.with_streaming_response.delete(
            repo="repo",
            namespace="namespace",
            key="key",
        ) as response:
    ...
    def test_path_params_delete(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.spaces.secrets.with_raw_response.delete(
                repo="repo",
                namespace="",
                key="key",
            )
    ...
    def test_method_upsert(self, client: HuggingFace) -> None:
        secret = client.api.spaces.secrets.upsert(
            repo="repo",
            namespace="namespace",
            key="key",
        )
    ...
    def test_raw_response_upsert(self, client: HuggingFace) -> None:
        response = client.api.spaces.secrets.with_raw_response.upsert(
            repo="repo",
            namespace="namespace",
            key="key",
        )
    ...
    def test_streaming_response_upsert(self, client: HuggingFace) -> None:
        with client.api.spaces.secrets.with_streaming_response.upsert(
            repo="repo",
            namespace="namespace",
            key="key",
        ) as response:
    ...
    def test_path_params_upsert(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.spaces.secrets.with_raw_response.upsert(
                repo="repo",
                namespace="",
                key="key",
            )
...
class TestAsyncSecrets:
    ...
    async def test_method_delete(self, async_client: AsyncHuggingFace) -> None:
        secret = await async_client.api.spaces.secrets.delete(
            repo="repo",
            namespace="namespace",
            key="key",
        )
    ...
    async def test_raw_response_delete(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.spaces.secrets.with_raw_response.delete(
            repo="repo",
            namespace="namespace",
            key="key",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.spaces.secrets.with_streaming_response.delete(
            repo="repo",
            namespace="namespace",
            key="key",
        ) as response:
    ...
    async def test_path_params_delete(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.spaces.secrets.with_raw_response.delete(
                repo="repo",
                namespace="",
                key="key",
            )
    ...
    async def test_method_upsert(self, async_client: AsyncHuggingFace) -> None:
        secret = await async_client.api.spaces.secrets.upsert(
            repo="repo",
            namespace="namespace",
            key="key",
        )
    ...
    async def test_raw_response_upsert(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.spaces.secrets.with_raw_response.upsert(
            repo="repo",
            namespace="namespace",
            key="key",
        )
    ...
    async def test_streaming_response_upsert(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.spaces.secrets.with_streaming_response.upsert(
            repo="repo",
            namespace="namespace",
            key="key",
        ) as response:
    ...
    async def test_path_params_upsert(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.spaces.secrets.with_raw_response.upsert(
                repo="repo",
                namespace="",
                key="key",
            )
