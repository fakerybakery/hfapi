...
from hugging_face.types.api.spaces import (
    LFSFileListResponse,
)
...
class TestLFSFiles:
    ...
    def test_method_list(self, client: HuggingFace) -> None:
        lfs_file = client.api.spaces.lfs_files.list(
            repo="repo",
            namespace="namespace",
        )
    ...
    def test_raw_response_list(self, client: HuggingFace) -> None:
        response = client.api.spaces.lfs_files.with_raw_response.list(
            repo="repo",
            namespace="namespace",
        )
    ...
    def test_streaming_response_list(self, client: HuggingFace) -> None:
        with client.api.spaces.lfs_files.with_streaming_response.list(
            repo="repo",
            namespace="namespace",
        ) as response:
    ...
    def test_path_params_list(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.spaces.lfs_files.with_raw_response.list(
                repo="repo",
                namespace="",
            )
    ...
    def test_method_delete(self, client: HuggingFace) -> None:
        lfs_file = client.api.spaces.lfs_files.delete(
            sha="sha",
            namespace="namespace",
            repo="repo",
        )
    ...
    def test_raw_response_delete(self, client: HuggingFace) -> None:
        response = client.api.spaces.lfs_files.with_raw_response.delete(
            sha="sha",
            namespace="namespace",
            repo="repo",
        )
    ...
    def test_streaming_response_delete(self, client: HuggingFace) -> None:
        with client.api.spaces.lfs_files.with_streaming_response.delete(
            sha="sha",
            namespace="namespace",
            repo="repo",
        ) as response:
    ...
    def test_path_params_delete(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.spaces.lfs_files.with_raw_response.delete(
                sha="sha",
                namespace="",
                repo="repo",
            )
    ...
    def test_method_delete_batch(self, client: HuggingFace) -> None:
        lfs_file = client.api.spaces.lfs_files.delete_batch(
            repo="repo",
            namespace="namespace",
    ...
    def test_raw_response_delete_batch(self, client: HuggingFace) -> None:
        response = client.api.spaces.lfs_files.with_raw_response.delete_batch(
            repo="repo",
            namespace="namespace",
            deletions={"sha": ["string"]},
        )
    ...
    def test_streaming_response_delete_batch(self, client: HuggingFace) -> None:
        with client.api.spaces.lfs_files.with_streaming_response.delete_batch(
            repo="repo",
            namespace="namespace",
            deletions={"sha": ["string"]},
        ) as response:
    ...
    def test_path_params_delete_batch(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.spaces.lfs_files.with_raw_response.delete_batch(
                repo="repo",
                namespace="",
                deletions={"sha": ["string"]},
            )
...
class TestAsyncLFSFiles:
    ...
    async def test_method_list(self, async_client: AsyncHuggingFace) -> None:
        lfs_file = await async_client.api.spaces.lfs_files.list(
            repo="repo",
            namespace="namespace",
        )
        assert_matches_type(LFSFileListResponse, lfs_file, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.spaces.lfs_files.with_raw_response.list(
            repo="repo",
            namespace="namespace",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.spaces.lfs_files.with_streaming_response.list(
            repo="repo",
            namespace="namespace",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_list(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.spaces.lfs_files.with_raw_response.list(
                repo="repo",
                namespace="",
            )
    ...
    async def test_method_delete(self, async_client: AsyncHuggingFace) -> None:
        lfs_file = await async_client.api.spaces.lfs_files.delete(
            sha="sha",
            namespace="namespace",
            repo="repo",
        )
    ...
    async def test_raw_response_delete(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.spaces.lfs_files.with_raw_response.delete(
            sha="sha",
            namespace="namespace",
            repo="repo",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.spaces.lfs_files.with_streaming_response.delete(
            sha="sha",
            namespace="namespace",
            repo="repo",
        ) as response:
    ...
    async def test_path_params_delete(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.spaces.lfs_files.with_raw_response.delete(
                sha="sha",
                namespace="",
                repo="repo",
            )
    ...
    async def test_method_delete_batch(self, async_client: AsyncHuggingFace) -> None:
        lfs_file = await async_client.api.spaces.lfs_files.delete_batch(
            repo="repo",
            namespace="namespace",
            deletions={"sha": ["string"]},
        )
    ...
    async def test_raw_response_delete_batch(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.spaces.lfs_files.with_raw_response.delete_batch(
            repo="repo",
            namespace="namespace",
            deletions={"sha": ["string"]},
        )
    ...
    async def test_streaming_response_delete_batch(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.spaces.lfs_files.with_streaming_response.delete_batch(
            repo="repo",
            namespace="namespace",
            deletions={"sha": ["string"]},
        ) as response:
    ...
    async def test_path_params_delete_batch(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.spaces.lfs_files.with_raw_response.delete_batch(
                repo="repo",
                namespace="",
                deletions={"sha": ["string"]},
            )
