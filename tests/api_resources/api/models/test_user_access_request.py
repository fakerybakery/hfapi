...
from hugging_face.types.api.models import (
...
class TestUserAccessRequest:
    ...
    def test_method_list(self, client: HuggingFace) -> None:
        user_access_request = client.api.models.user_access_request.list(
            status="pending",
            namespace="namespace",
            repo="repo",
        )
    ...
    def test_raw_response_list(self, client: HuggingFace) -> None:
        response = client.api.models.user_access_request.with_raw_response.list(
            status="pending",
            namespace="namespace",
            repo="repo",
        )
    ...
    def test_streaming_response_list(self, client: HuggingFace) -> None:
        with client.api.models.user_access_request.with_streaming_response.list(
            status="pending",
            namespace="namespace",
            repo="repo",
        ) as response:
    ...
    def test_path_params_list(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.models.user_access_request.with_raw_response.list(
                status="pending",
                namespace="",
                repo="repo",
            )
    ...
    def test_method_cancel(self, client: HuggingFace) -> None:
        user_access_request = client.api.models.user_access_request.cancel(
            repo="repo",
            namespace="namespace",
        )
    ...
    def test_raw_response_cancel(self, client: HuggingFace) -> None:
        response = client.api.models.user_access_request.with_raw_response.cancel(
            repo="repo",
            namespace="namespace",
        )
    ...
    def test_streaming_response_cancel(self, client: HuggingFace) -> None:
        with client.api.models.user_access_request.with_streaming_response.cancel(
            repo="repo",
            namespace="namespace",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_cancel(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.models.user_access_request.with_raw_response.cancel(
                repo="repo",
                namespace="",
            )
    ...
    def test_method_grant(self, client: HuggingFace) -> None:
        user_access_request = client.api.models.user_access_request.grant(
            repo="repo",
            namespace="namespace",
        )
        assert user_access_request is None
    ...
    def test_raw_response_grant(self, client: HuggingFace) -> None:
        response = client.api.models.user_access_request.with_raw_response.grant(
            repo="repo",
            namespace="namespace",
        )
    ...
    def test_streaming_response_grant(self, client: HuggingFace) -> None:
        with client.api.models.user_access_request.with_streaming_response.grant(
            repo="repo",
            namespace="namespace",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_grant(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.models.user_access_request.with_raw_response.grant(
                repo="repo",
                namespace="",
            )
    ...
    def test_method_handle(self, client: HuggingFace) -> None:
        user_access_request = client.api.models.user_access_request.handle(
            repo="repo",
            namespace="namespace",
            status="accepted",
        )
    ...
    def test_raw_response_handle(self, client: HuggingFace) -> None:
        response = client.api.models.user_access_request.with_raw_response.handle(
            repo="repo",
            namespace="namespace",
            status="accepted",
        )
    ...
    def test_streaming_response_handle(self, client: HuggingFace) -> None:
        with client.api.models.user_access_request.with_streaming_response.handle(
            repo="repo",
            namespace="namespace",
            status="accepted",
        ) as response:
    ...
    def test_path_params_handle(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.models.user_access_request.with_raw_response.handle(
                repo="repo",
                namespace="",
                status="accepted",
            )
...
class TestAsyncUserAccessRequest:
    ...
    async def test_method_list(self, async_client: AsyncHuggingFace) -> None:
        user_access_request = await async_client.api.models.user_access_request.list(
            status="pending",
            namespace="namespace",
            repo="repo",
        )
    ...
    async def test_raw_response_list(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.models.user_access_request.with_raw_response.list(
            status="pending",
            namespace="namespace",
            repo="repo",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.models.user_access_request.with_streaming_response.list(
            status="pending",
            namespace="namespace",
            repo="repo",
        ) as response:
    ...
    async def test_path_params_list(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.models.user_access_request.with_raw_response.list(
                status="pending",
                namespace="",
                repo="repo",
            )
    ...
    async def test_method_cancel(self, async_client: AsyncHuggingFace) -> None:
        user_access_request = await async_client.api.models.user_access_request.cancel(
            repo="repo",
            namespace="namespace",
        )
        assert user_access_request is None
    ...
    async def test_raw_response_cancel(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.models.user_access_request.with_raw_response.cancel(
            repo="repo",
            namespace="namespace",
        )
    ...
    async def test_streaming_response_cancel(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.models.user_access_request.with_streaming_response.cancel(
            repo="repo",
            namespace="namespace",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_cancel(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.models.user_access_request.with_raw_response.cancel(
                repo="repo",
                namespace="",
            )
    ...
    async def test_method_grant(self, async_client: AsyncHuggingFace) -> None:
        user_access_request = await async_client.api.models.user_access_request.grant(
            repo="repo",
            namespace="namespace",
        )
        assert user_access_request is None
    ...
    async def test_raw_response_grant(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.models.user_access_request.with_raw_response.grant(
            repo="repo",
            namespace="namespace",
        )
    ...
    async def test_streaming_response_grant(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.models.user_access_request.with_streaming_response.grant(
            repo="repo",
            namespace="namespace",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_grant(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.models.user_access_request.with_raw_response.grant(
                repo="repo",
                namespace="",
            )
    ...
    async def test_method_handle(self, async_client: AsyncHuggingFace) -> None:
        user_access_request = await async_client.api.models.user_access_request.handle(
            repo="repo",
            namespace="namespace",
            status="accepted",
        )
    ...
    async def test_raw_response_handle(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.models.user_access_request.with_raw_response.handle(
            repo="repo",
            namespace="namespace",
            status="accepted",
        )
    ...
    async def test_streaming_response_handle(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.models.user_access_request.with_streaming_response.handle(
            repo="repo",
            namespace="namespace",
            status="accepted",
        ) as response:
    ...
    async def test_path_params_handle(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.models.user_access_request.with_raw_response.handle(
                repo="repo",
                namespace="",
                status="accepted",
            )
