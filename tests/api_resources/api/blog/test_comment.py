...
from hugging_face.types.api.blog import (
...
class TestComment:
    ...
    def test_method_create(self, client: HuggingFace) -> None:
        comment = client.api.blog.comment.create(
            slug="slug",
            comment="x",
        )
    ...
    def test_raw_response_create(self, client: HuggingFace) -> None:
        response = client.api.blog.comment.with_raw_response.create(
            slug="slug",
            comment="x",
        )
    ...
    def test_streaming_response_create(self, client: HuggingFace) -> None:
        with client.api.blog.comment.with_streaming_response.create(
            slug="slug",
            comment="x",
        ) as response:
    ...
    def test_path_params_create(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `slug` but received ''"):
            client.api.blog.comment.with_raw_response.create(
                slug="",
                comment="x",
            )
    ...
    def test_method_create_with_namespace(self, client: HuggingFace) -> None:
        comment = client.api.blog.comment.create_with_namespace(
            slug="slug",
            namespace="namespace",
            comment="x",
        )
        assert_matches_type(CommentCreateWithNamespaceResponse, comment, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_create_with_namespace(self, client: HuggingFace) -> None:
        response = client.api.blog.comment.with_raw_response.create_with_namespace(
            slug="slug",
            namespace="namespace",
            comment="x",
        )
    ...
    def test_streaming_response_create_with_namespace(self, client: HuggingFace) -> None:
        with client.api.blog.comment.with_streaming_response.create_with_namespace(
            slug="slug",
            namespace="namespace",
            comment="x",
        ) as response:
    ...
    def test_path_params_create_with_namespace(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.blog.comment.with_raw_response.create_with_namespace(
                slug="slug",
                namespace="",
                comment="x",
            )
...
class TestAsyncComment:
    ...
    async def test_method_create(self, async_client: AsyncHuggingFace) -> None:
        comment = await async_client.api.blog.comment.create(
            slug="slug",
            comment="x",
        )
        assert_matches_type(CommentCreateResponse, comment, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.blog.comment.with_raw_response.create(
            slug="slug",
            comment="x",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.blog.comment.with_streaming_response.create(
            slug="slug",
            comment="x",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_create(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `slug` but received ''"):
            await async_client.api.blog.comment.with_raw_response.create(
                slug="",
                comment="x",
            )
    ...
    async def test_method_create_with_namespace(self, async_client: AsyncHuggingFace) -> None:
        comment = await async_client.api.blog.comment.create_with_namespace(
            slug="slug",
            namespace="namespace",
            comment="x",
        )
    ...
    async def test_raw_response_create_with_namespace(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.blog.comment.with_raw_response.create_with_namespace(
            slug="slug",
            namespace="namespace",
            comment="x",
        )
    ...
    async def test_streaming_response_create_with_namespace(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.blog.comment.with_streaming_response.create_with_namespace(
            slug="slug",
            namespace="namespace",
            comment="x",
        ) as response:
    ...
    async def test_path_params_create_with_namespace(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.blog.comment.with_raw_response.create_with_namespace(
                slug="slug",
                namespace="",
                comment="x",
            )
