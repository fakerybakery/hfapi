...
from hugging_face.types.api.datasets import (
...
class TestResourceGroup:
    ...
    def test_method_add(self, client: HuggingFace) -> None:
        resource_group = client.api.datasets.resource_group.add(
            repo="repo",
            namespace="namespace",
    ...
    def test_raw_response_add(self, client: HuggingFace) -> None:
        response = client.api.datasets.resource_group.with_raw_response.add(
            repo="repo",
            namespace="namespace",
            resource_group_id="ecc2efdd09bd231a9ad9bd2a",
        )
    ...
    def test_streaming_response_add(self, client: HuggingFace) -> None:
        with client.api.datasets.resource_group.with_streaming_response.add(
            repo="repo",
            namespace="namespace",
            resource_group_id="ecc2efdd09bd231a9ad9bd2a",
        ) as response:
    ...
    def test_path_params_add(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.datasets.resource_group.with_raw_response.add(
                repo="repo",
                namespace="",
                resource_group_id="ecc2efdd09bd231a9ad9bd2a",
            )
    ...
    def test_method_get(self, client: HuggingFace) -> None:
        resource_group = client.api.datasets.resource_group.get(
            repo="repo",
            namespace="namespace",
        )
    ...
    def test_raw_response_get(self, client: HuggingFace) -> None:
        response = client.api.datasets.resource_group.with_raw_response.get(
            repo="repo",
            namespace="namespace",
        )
    ...
    def test_streaming_response_get(self, client: HuggingFace) -> None:
        with client.api.datasets.resource_group.with_streaming_response.get(
            repo="repo",
            namespace="namespace",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_get(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.datasets.resource_group.with_raw_response.get(
                repo="repo",
                namespace="",
            )
...
class TestAsyncResourceGroup:
    ...
    async def test_method_add(self, async_client: AsyncHuggingFace) -> None:
        resource_group = await async_client.api.datasets.resource_group.add(
            repo="repo",
            namespace="namespace",
            resource_group_id="ecc2efdd09bd231a9ad9bd2a",
        )
    ...
    async def test_raw_response_add(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.datasets.resource_group.with_raw_response.add(
            repo="repo",
            namespace="namespace",
            resource_group_id="ecc2efdd09bd231a9ad9bd2a",
        )
    ...
    async def test_streaming_response_add(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.datasets.resource_group.with_streaming_response.add(
            repo="repo",
            namespace="namespace",
            resource_group_id="ecc2efdd09bd231a9ad9bd2a",
        ) as response:
    ...
    async def test_path_params_add(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.datasets.resource_group.with_raw_response.add(
                repo="repo",
                namespace="",
                resource_group_id="ecc2efdd09bd231a9ad9bd2a",
            )
    ...
    async def test_method_get(self, async_client: AsyncHuggingFace) -> None:
        resource_group = await async_client.api.datasets.resource_group.get(
            repo="repo",
            namespace="namespace",
        )
        assert_matches_type(ResourceGroupGetResponse, resource_group, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.datasets.resource_group.with_raw_response.get(
            repo="repo",
            namespace="namespace",
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.datasets.resource_group.with_streaming_response.get(
            repo="repo",
            namespace="namespace",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.datasets.resource_group.with_raw_response.get(
                repo="repo",
                namespace="",
            )
