...
class TestTag:
    ...
    def test_method_create(self, client: HuggingFace) -> None:
        tag = client.api.datasets.tag.create(
            rev="rev",
            namespace="namespace",
            repo="repo",
            tag="tag",
    ...
    def test_raw_response_create(self, client: HuggingFace) -> None:
        response = client.api.datasets.tag.with_raw_response.create(
            rev="rev",
            namespace="namespace",
            repo="repo",
            tag="tag",
    ...
    def test_streaming_response_create(self, client: HuggingFace) -> None:
        with client.api.datasets.tag.with_streaming_response.create(
            rev="rev",
            namespace="namespace",
            repo="repo",
            tag="tag",
    ...
    def test_path_params_create(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.datasets.tag.with_raw_response.create(
                rev="rev",
                namespace="",
                repo="repo",
                tag="tag",
    ...
    def test_method_delete(self, client: HuggingFace) -> None:
        tag = client.api.datasets.tag.delete(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
    ...
    def test_raw_response_delete(self, client: HuggingFace) -> None:
        response = client.api.datasets.tag.with_raw_response.delete(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
    ...
    def test_streaming_response_delete(self, client: HuggingFace) -> None:
        with client.api.datasets.tag.with_streaming_response.delete(
            rev="rev",
            namespace="namespace",
            repo="repo",
        ) as response:
    ...
    def test_path_params_delete(self, client: HuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            client.api.datasets.tag.with_raw_response.delete(
                rev="rev",
                namespace="",
                repo="repo",
            )
...
class TestAsyncTag:
    ...
    async def test_method_create(self, async_client: AsyncHuggingFace) -> None:
        tag = await async_client.api.datasets.tag.create(
            rev="rev",
            namespace="namespace",
            repo="repo",
            tag="tag",
    ...
    async def test_raw_response_create(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.datasets.tag.with_raw_response.create(
            rev="rev",
            namespace="namespace",
            repo="repo",
            tag="tag",
    ...
    async def test_streaming_response_create(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.datasets.tag.with_streaming_response.create(
            rev="rev",
            namespace="namespace",
            repo="repo",
            tag="tag",
    ...
    async def test_path_params_create(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.datasets.tag.with_raw_response.create(
                rev="rev",
                namespace="",
                repo="repo",
                tag="tag",
    ...
    async def test_method_delete(self, async_client: AsyncHuggingFace) -> None:
        tag = await async_client.api.datasets.tag.delete(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
    ...
    async def test_raw_response_delete(self, async_client: AsyncHuggingFace) -> None:
        response = await async_client.api.datasets.tag.with_raw_response.delete(
            rev="rev",
            namespace="namespace",
            repo="repo",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncHuggingFace) -> None:
        async with async_client.api.datasets.tag.with_streaming_response.delete(
            rev="rev",
            namespace="namespace",
            repo="repo",
        ) as response:
    ...
    async def test_path_params_delete(self, async_client: AsyncHuggingFace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `namespace` but received ''"):
            await async_client.api.datasets.tag.with_raw_response.delete(
                rev="rev",
                namespace="",
                repo="repo",
            )
